...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<!-- <div class="bnr-right">
				...
				<div class="grand">
					<p>Grand Total</p>
					<h3>GH₵ <?php echo htmlentities($result->PackagePrice );?></h3>
				</div>
			</div>
		...
		<div class="selectroom_top">
			...
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					<br>
					<h7>NB* Before Your Booking(s) Will Be Confirm You Need To Make Payment</h7>
					<br>
					<br>
					<div data-wow-delay=".5s">
					<a href="../stripe-payment-gateway-integration-php/index.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Make Payment</a>
				</div>
						</li>
						<?php } else {?>
